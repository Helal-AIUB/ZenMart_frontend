        ...
        <div className="flex items-center gap-6 w-full sm:w-auto justify-between sm:justify-end">
          <div className="flex items-center gap-3 bg-card-border/30 border border-card-border px-4 py-2 rounded-2xl">
            ...
            <div className="flex items-center gap-1.5 text-foreground font-black text-sm">
              <div className="bg-card px-2 py-1 rounded-md min-w-[32px] text-center border border-card-border">{String(timeLeft.hours).padStart(2, '0')}</div>
              <span className="text-primary font-bold">:</span>
              <div className="bg-card px-2 py-1 rounded-md min-w-[32px] text-center border border-card-border">{String(timeLeft.minutes).padStart(2, '0')}</div>
              <span className="text-primary font-bold">:</span>
              <div className="bg-primary text-white px-2 py-1 rounded-md min-w-[32px] text-center">{String(timeLeft.seconds).padStart(2, '0')}</div>
            </div>
          </div>
