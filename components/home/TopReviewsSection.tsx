...
export default async function TopReviewsSection() {
  try {
    ...
    return (
      <section className="pt-10 pb-20 md:pt-12 md:pb-28 bg-[#f8f9fa] overflow-hidden font-sans">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 mb-10 md:mb-14 text-center">
          ...
          <p className="text-sm md:text-base text-muted max-w-2xl mx-auto font-medium">
